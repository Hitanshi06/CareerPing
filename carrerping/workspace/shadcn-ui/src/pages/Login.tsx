...
import { ArrowLeft, Zap, Mail, Lock, User, Building } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Sign in to track events and build your professional passport
          </p>
        </div>
              ...
              <TabsContent value="attendee">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button 
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? 'Signing in...' : 'Sign In as Attendee'}
                  </Button>
                </form>
                
                <div className="mt-4 text-center">
                  <p className="text-sm text-gray-600">
                    New to Event Centralizer?{' '}
